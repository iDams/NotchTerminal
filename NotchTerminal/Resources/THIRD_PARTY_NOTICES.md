...
NotchTerminal uses SwiftTerm for terminal emulation.
...
## Port-Killer (Inspiration and Partial Logic)
...
NotchTerminal may display command branding icons for external tools/services.
These names, logos, and trademarks are owned by their respective trademark holders.
Usage in this project is nominative and for identification in UI only.
